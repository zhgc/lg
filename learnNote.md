...
+分支管理:
    ...
    - a new way to switch branchs
        ...
        * `git switch -d dev` mean delate branch dev.    - 2020103 made,zhebishiwozhongjiushiganle,zongzhijiushihenhouhui,,jishinianhouruguowoshenbaiminglianajiushiyinweizheshi.
